...
public class MaquinaVirtual {
	...
	public ArrayList<Quadruplo> quadruplos = new ArrayList<Quadruplo>(); //lista de los qu�druplos cargados del c�digo intermedio
	private ArrayList<VariableInt> contEntGlo = new ArrayList<VariableInt>(); //lista de las variables enteras globales cargadas del c�digo intermedio
	private ArrayList<VariableFloat> contFlotGlo = new ArrayList<VariableFloat>(); //lista de las variables flotantes globales cargadas del c�digo intermedio
	private ArrayList<VariableStr> contStrGlo = new ArrayList<VariableStr>(); //lista de las variables String globales cargadas del c�digo intermedio
	private ArrayList<VariableBool> contBoolGlo = new ArrayList<VariableBool>(); //lista de las variables booleanas globales cargadas del c�digo intermedio
	private ArrayList<VariableInt> contEntLoc = new ArrayList<VariableInt>(); //lista de las variables enteras locales cargadas del c�digo intermedio
	private ArrayList<VariableFloat> contFlotLoc = new ArrayList<VariableFloat>(); //lista de las variables flotantes locales cargadas del c�digo intermedio
	private ArrayList<VariableStr> contStrLoc = new ArrayList<VariableStr>(); //lista de las variables String locales cargadas del c�digo intermedio
	private ArrayList<VariableBool> contBoolLoc = new ArrayList<VariableBool>(); //lista de las variables booleanas locales cargadas del c�digo intermedio
	private ArrayList<VariableInt> contEntTmp = new ArrayList<VariableInt>(); //lista de las variables enteras temporales cargadas del c�digo intermedio
	private ArrayList<VariableFloat> contFlotTmp = new ArrayList<VariableFloat>(); //lista de las variables flotantes temporales cargadas del c�digo intermedio
	private ArrayList<VariableStr> contStrTmp = new ArrayList<VariableStr>(); //lista de las variables String temporales cargadas del c�digo intermedio
	private ArrayList<VariableBool> contBoolTmp = new ArrayList<VariableBool>(); //lista de las variables booleanas temporales cargadas del c�digo intermedio
	private ArrayList<VariableInt> contEntCons = new ArrayList<VariableInt>(); //lista de las variables enteras constantes cargadas del c�digo intermedio
	private ArrayList<VariableFloat> contFlotCons = new ArrayList<VariableFloat>(); //lista de las variables flotantes constantes cargadas del c�digo intermedio
	private ArrayList<VariableStr> contStrCons = new ArrayList<VariableStr>(); //lista de las variables String constantes cargadas del c�digo intermedio
	private ArrayList<VariableBool> contBoolCons = new ArrayList<VariableBool>(); //lista de las variables booleanas constantes cargadas del c�digo intermedio
	private ArrayList<Procedimiento> procedimientos = new ArrayList<Procedimiento>();
	private JTextArea jtAreaOutput; //�rea de texto donde va a imprimir
	private int [] apuntadoresInstruccion; //apunta a la instrucci�n a ejecutarse de los qu�druplos
	private int apuntador; //apunta a la posici�n del arreglo de instruccinoes para ejecutar el qu�druplo
	...
	// Obtiene el valor de la direcci�n que se proporciona y regresa el valor y su tipo de dato
	...
	// m�todo para cargar las variables locales y temporales de una funci�n
	...
	// m�todo para descargar las variables locales y temporales de una funci�n
	...
	// m�todo para encontrar el cu�druplo inicial de la funci�n
